...
class Pay extends Controller
{
		...
		if ($_var_0) {
			...
			if ($_var_1) {
				if ($_var_1['power'] == 0 || $_var_1['power'] == 1) {
					return json(['code' => 500, 'error' => '以开通合伙人']);
				} else {
					$_var_2 = db('rebate')->where('id', 1)->find()['money'];
					return json(['code' => 200, 'pay_url' => "http://demo1.winds.fun/paydl/index.php?name=开通合伙人&fee={$_var_2}&u_id={$_var_0}"]);
				}
			} else {
	...
	public function pay_qicaiwangluo()
	{
		$_var_3 = input();
